...
#
# One-off operator deposit of the constitutive-note v1.9 anchor.
# Sibling of anchor_inaugural_constitutive_note_v18.rb; only the frozen facts
# differ. The anchor store is Synoptis::Anchoring (append-line hash-chained log);
# the v17 script's Hestia::Anchoring namespace is gone and must not be used.
#
...
#     --entrypoint ruby docker-meeting-place:latest - < this_script.rb
#
...
# v1.7 sits at chain position #0 and v1.8 at #1; this appends v1.9 at #2 on the
# SAME chain.
...
# --- Frozen facts from the v1.9 deposit. Do not edit. -------------------------
# DIGEST is the SHA-256 of the deposited English Markdown's raw bytes
# (constitutive_recording_by_construction_v1.9.md, 81073 bytes; LF + UTF-8 NFC;
# editorial-status note absent). Re-hashed from the public Zenodo copy on
# 2026-08-03 and byte-identical to the local frozen file.
DIGEST = '527125be9d33942e77c68cbfddaae92721de1332db4f47b8a2cb92b202bfdad5'
SOURCE = 'place://meeting.genomicschain.io/anchor/constitutive-note-v1.9'
DOI    = 'doi:10.5281/zenodo.21766502'
NOTE   = 'SHA-256 of constitutive-note v1.9 matches the Zenodo deposit ' \
         '(DOI 10.5281/zenodo.21766502); constitutively recorded on MasaChain ' \
         'block 620, deposit manifest corrected by block 621; e2e re-hash from ' \
         'public Zenodo verified 2026-08-03.'
# ------------------------------------------------------------------------------
...
warn "current chain length = #{log.length} (v1.7 = #0, v1.8 = #1; this deposits at ##{log.length})"
