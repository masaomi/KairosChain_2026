...
- [Payment Flow (Proof-Centric)](#payment-flow-proof-centric)
- [Anti-Sybil Measures](#anti-sybil-measures)
- [MCP Tools](#mcp-tools)
- [Configuration Example](#configuration-example)
- [Dependencies](#dependencies)
- [Synoptis: Mutual Attestation Protocol (v3.5.0)](#synoptis-mutual-attestation-protocol-v350)
