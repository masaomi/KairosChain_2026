...
3 体の言語モデルに、**ルールを書き換えることがルールになっているゲーム**を打たせた。Peter Suber が 1980 年に考案した Nomic の最小版である。9 個の初期ルール（101〜109）から始まり、そのすべてが変更可能。4 体目が進行役として手番だけを決める。
...
**忠実性**（§6 で「解決していない」と述べた相手）— Turpin ら 2023、arXiv:2505.05410、arXiv:2503.08679。
